...
const slides: Slide[] = [
  ...
  {
    id: 2,
    title: 'PROTEÍNA VEGETAL DE ALTA CALIDAD',
    subtitle:
      'Ideal para platillos caseros, restaurantes y negocios que quieren ofrecer opciones saludables.',
    image: '/banner-2.jpg',
  },
  {
    id: 3,
    title: 'VERSÁTIL, NUTRITIVA Y DELICIOSA',
    subtitle:
      'Tacos, pastas, sopas y mucho más, todo con el sabor de la soya texturizada.',
    image: '/banner-3.jpg',
  },
];
